 ...
 */
public abstract class Hilt_PhotosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhotosFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhotosFragment_GeneratedInjector) this.generatedComponent()).injectPhotosFragment(UnsafeCasts.<PhotosFragment>unsafeCast(this));
    }
  }
